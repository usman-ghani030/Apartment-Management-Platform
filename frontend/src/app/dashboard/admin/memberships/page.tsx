              ...
              <form onSubmit={handleInvite} className="space-y-4">
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input type="text" value={inviteName} onChange={(e) => setInviteName(e.target.value)} placeholder="John Doe" required maxLength={100} className="w-full bg-gray-50 border border-gray-200 rounded-lg px-4 py-2.5 text-sm text-gray-900 placeholder-gray-500 pl-10 pr-4 focus:outline-none focus:border-accent-500/50" />
                  </div>
                </div>
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input type="email" value={inviteEmail} onChange={(e) => setInviteEmail(e.target.value)} placeholder="user@example.com" required maxLength={200} className="w-full bg-gray-50 border border-gray-200 rounded-lg px-4 py-2.5 text-sm text-gray-900 placeholder-gray-500 pl-10 pr-4 focus:outline-none focus:border-accent-500/50" />
                  </div>
                </div>
                <div>
