...
- **Requires human action on the hosts** (cannot be set from the repo): set the Vercel env vars and redeploy, and add the deployed origin in Google Cloud Console
